...
- Simple sensor payloads use integers. Temperature uses one integer average Celsius value. LED and projector use integer `1` or `0`. AC uses `PPTTFFSS`. Alert uses a decimal integer bitmask.
